...
class Habit:
    ...
    def serialize(self):
        ...
        _habitdict["completed_dates"] = [
            date.isoformat() for date in self.completed_dates
        ]
    ...
    def deserialize(cls, _dict):
        ...
        _habit = cls(
            _dict.get("name", "NoName"),
            _dict.get("description", "NoDesc"),
            _creation_date,
            _dict.get("active"),
        )
        _habit.completed_dates = [
            datetime.fromisoformat(date_str).date()
            for date_str in _dict.get("completed_dates")
        ]
